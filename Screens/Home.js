...
import { Card, CardItem, Root, Header } from "native-base";
                ...
                <ScrollView style={{ flex: 1, backgroundColor: "#eeeeee" }}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                this.props.navigation.navigate("CatView", {
                                    details: { text: "အသား/ငါး ဟင်းပြုလုပ်နည်းများ", type: "type1" }
                                })
                            }}
                        >
                    ...
                    >
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                this.props.navigation.navigate("CatView", {
                                    details: { text: "အသီးအရွက် ဟင်းပြုလုပ်နည်းများ", type: "type2" }
                                })
                            }}
                        >
                            <Text style={{ color: "white" }}>See All</Text>
